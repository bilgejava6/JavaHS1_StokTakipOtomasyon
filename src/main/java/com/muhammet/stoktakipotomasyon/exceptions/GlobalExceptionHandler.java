...
import static com.muhammet.stoktakipotomasyon.exceptions.ErrorType.BAD_REQUEST_ERROR;
...
public class GlobalExceptionHandler {
     ...
     *
     */
    @ExceptionHandler(StokTakipException.class)
    @ResponseBody
    public ResponseEntity<ResponseDto> handlerSatisException(StokTakipException satisException){
